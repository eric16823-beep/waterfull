...
<svg xmlns="http://www.w3.org/2000/svg" width="${width}" height="${height}">
  <style>
    .wm { font-family: "Microsoft YaHei", "SimHei", "PingFang SC", "Hiragino Sans", "Source Han Sans", "Noto Sans CJK", Arial, sans-serif; font-size: ${scaledFontSize}px; fill: ${fill}; }
    .shadow { font-family: "Microsoft YaHei", "SimHei", "PingFang SC", "Hiragino Sans", "Source Han Sans", "Noto Sans CJK", Arial, sans-serif; font-size: ${scaledFontSize}px; fill: ${shadow}; }
  </style>
